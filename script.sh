...
aws cloudformation create-stack \
   --template-body file://backend-setupe.yaml \
...
git clone https://https://github.com/aws-samples/getting-started-with-amazon-redshift-data-api.git/AziizeLbaibianalytical-reporting-event-driven-web-app/repo.git
